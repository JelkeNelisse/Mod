...
public interface ITransposerManager
{
     ...
     *            ItemStack representing the input item.
     * @param output
     *            ItemStack representing the output item - this can be NULL if necessary, if the recipe is NOT reversible.
     * @param liquid
     *            LiquidStack representing the required liquid.
     * @param chance
     *            Integer representing % chance (out of 100) of receiving the item - liquid will always be extracted. If output is NULL, this MUST be set to 0.
     *            The recipe will not be added otherwise.
     * @param reversible
