...
public class ClientProxy extends CommonProxy
{
    ...
    RenderingRegistry.instance().registerEntityRenderingHandler(EntityBoomer.class, new RenderBoomer(new ModelBoomer(), 0.3F)); //Register the rendering for your entities. 
    } 
