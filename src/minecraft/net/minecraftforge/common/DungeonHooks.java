...
public class DungeonHooks
{
    ...
    {
        return ChestGenHooks.getInfo(DUNGEON_CHEST).getMax();
    }
    @Deprecated //Moved to ChestGenHooks
    public void addDungeonLoot(DungeonLoot loot)
    {
        ChestGenHooks.getInfo(DUNGEON_CHEST).addItem(loot);
    }
    @Deprecated //Moved to ChestGenHooks
    public boolean removeDungeonLoot(DungeonLoot loot)
    {
        return ChestGenHooks.getInfo(DUNGEON_CHEST).contents.remove(loot);
    }
    @Deprecated //Moved to ChestGenHooks
    ...
    {
        ChestGenHooks.removeItem(DUNGEON_CHEST, item);
    }
    @Deprecated //Moved to ChestGenHooks
    ...
    {
        return ChestGenHooks.getOneItem(DUNGEON_CHEST, rand);
    }
    ...
    public static class DungeonLoot extends WeightedRandomChestContent
    {
        ...
        {
            return item.isItemEqual(theItemId) && ItemStack.areItemStackTagsEqual(item, theItemId);
        }
    }
}
